...
const UpdateStudentDetails = ({ id }) => {
  ...
  const preData = async () => {
    axios.get(`https://dms2901.onrender.com/student/getStudentDetails/${id}`).then(
      (data) => {
  ...
  const updateData = async () => {
    await axios.patch(`https://dms2901.onrender.com/admin/updateStudent`, formData).then(
      (data) => {
